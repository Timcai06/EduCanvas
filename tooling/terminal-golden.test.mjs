...
import { renderRecord, renderSummaryLine } from './local-pretty.mjs';
import { renderStatusCard } from './local-runtime-ops.mjs';
import { GLYPHS, SUMMARY_RULE } from './terminal/glyphs.mjs';
import { padDisplay } from './terminal/format.mjs';
...
const successStages = [
  ...
  { label: 'Web', ok: true, detail: 'http://127.0.0.1:3101', durationMs: 5100 },
