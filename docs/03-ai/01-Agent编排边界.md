...
- 关键决策：[ADR-0003](../09-decisions/0003-unified-runtime-and-notebook-context.md)、[ADR-0004](../09-decisions/0004-capability-trust-and-learning-evidence.md)
...
服务端判分、掌握度更新和状态转移不应作为普通写工具直接交给模型。模型可以建议测验或补救，确定性领域逻辑才有权提交学习事实。完整边界见 [ADR-0004](../09-decisions/0004-capability-trust-and-learning-evidence.md)。
