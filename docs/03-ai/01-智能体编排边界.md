...
- 关键决策：[ADR-0003](../09-decisions/0003-统一运行时与笔记本上下文.md)、[ADR-0004](../09-decisions/0004-能力信任与学习证据.md)、[ADR-0020](../09-decisions/0020-Personal与Notebook长期记忆边界.md)
...
服务端判分、掌握度更新和状态转移不应作为普通写工具直接交给模型。模型可以建议测验或补救，确定性领域逻辑才有权提交学习事实。完整边界见 [ADR-0004](../09-decisions/0004-能力信任与学习证据.md)。
