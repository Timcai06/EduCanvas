...
- 负责人：项目负责人
- 完成时间：2026-07-21
- 关键决策：[ADR-0002](../../09-decisions/0002-网关客户端渠道与能力节点.md)
...
- enabled Channel Adapter 的启动、停止、重连和 degraded health 转入[路线图 P0](../../10-planning/01-路线图.md)；
- 正式 IdP、session 撤销、密钥轮换、真实微信/QQ 与生产观测继续由路线图管理；
- 第二代架构不在本计划内实现，后续进入[研究与决策计划](2026-07-第二代架构研究.md)，研究完成后再转生产升级。

## 已回写事实源

- [核心用户流程](../../01-product/03-用户流程.md)
- [学生端 UI 规格](../../01-product/02-学生界面规范.md)
- [Gateway、客户端、渠道与能力节点](../../09-decisions/0002-网关客户端渠道与能力节点.md)
