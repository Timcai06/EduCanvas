...
- 负责人：项目负责人
- 完成时间：2026-07-15
- 对应路线图阶段：[阶段一：产品纵切](../../10-planning/01-路线图.md#阶段一产品纵切)
...
- 产品行为：[`../../01-product/02-学生界面规范.md`](../../01-product/02-学生界面规范.md)；
- 统一Canvas工作面：[`../../02-architecture/04-统一画布工作面.md`](../../02-architecture/04-统一画布工作面.md)；
- 前端边界：[`../../05-engineering/03-前端工程.md`](../../05-engineering/03-前端工程.md)；
- 测试基线：[`../../06-quality/03-测试与评估.md`](../../06-quality/03-测试与评估.md)；
- 长期路线图：[`../../10-planning/01-路线图.md`](../../10-planning/01-路线图.md)。
