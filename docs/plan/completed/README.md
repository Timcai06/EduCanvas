...
| 2026-09-17 | [`AR-AI产物显示优化.md`](AR-AI产物显示优化.md)                                       | 五渲染器读体验补齐、callout 闭环；走查改为可复现脚本，后置缺陷 #487/#488 已修       |
| 2026-09-17 | [`WS-Web搜索与研究来源.md`](WS-Web搜索与研究来源.md)                               | 网页导入、内置搜索与深度研究收口；WS09 由负责人接受，真实环境检查表未执行         |
