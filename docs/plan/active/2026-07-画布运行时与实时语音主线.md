...
**S3 状态：** U09 passed；ADR-0019 已通过 Codex 安全复审并由项目负责人 accepted，
U10 与 U11 已解锁且可并行开发。U12 必须等待 U10、U11 分别通过复审。
...
| 持久 Web Runtime           | `planned` | ADR-0019 与 28 条安全负例已 accepted；`sandbox-preview.ts` 仍只是轻量 srcdoc 预览，持久 Runtime 实现尚在 U10-U12                       | U09 passed；U10-U12 pending |
