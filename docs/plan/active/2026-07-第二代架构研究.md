...
- [ ] 建立 Notebook Privacy fixture：共享 Notebook 可见，但个人 Memory、Credential、Node 与 default grant 对其他 Actor fail closed。
  - [x] 第一条可执行纵切已证明共享 Notebook 保留各自 Personal Agent，并以 `it.fails` 固化跨 Actor Node invocation 缺口；Memory、Credential 与 default grant 尚无权威数据模型，见 [Notebook 隐私夹具](../../research/2026-07/05-Notebook隐私夹具.md)。
