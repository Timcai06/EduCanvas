...
稳定边界见[统一 Canvas 工作面](../02-architecture/04-统一Canvas工作面.md)与 [ADR-0009](../09-decisions/0009-统一Canvas工作面与运行时分层.md)，短期执行以[active plan](../plan/active/2026-07-统一Canvas工作面.md)为准。
