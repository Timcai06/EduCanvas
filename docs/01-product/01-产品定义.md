...
- 负责人：项目负责人
- 最后验证时间：2026-08-13
- 关键决策：[ADR-0001](../09-decisions/0001-以教育能力为核心的个人智能体平台.md)、[ADR-0009](../09-decisions/0009-统一画布工作面与运行时分层.md)、[ADR-0020](../09-decisions/0020-Personal与Notebook长期记忆边界.md)、[ADR-0028](../09-decisions/0028-桌宠作为统一EduCanvas系统的第一方桌面外延.md)
...
Web、Desktop Pet、TUI 或消息渠道只是访问同一个 Agent 的不同方式。切换 Notebook 必须整体切换 Sources、Conversations、Artifacts、Resource Dock、Studio 资源库、运行记录和相关记忆。
...
- **Desktop Pet**：已具备独立角色、文本/语音问答、TTS、原生登录和聊天窗口的第一方桌面入口；当前仍是固定 Conversation 与本地 View Cache，按 DP 计划迁移为服务端 Conversation/Message 的轻量投影，复杂内容由用户点击后交接到 Web/Canvas；
