...
- **Studio 是当前 Notebook 的输入/输出工作台**：第一层弧形轮盘只显示“文件输入 / 内容输出”，第二层才进入 PDF、图片、网页或思维导图、Slides、闪卡、音频等具体能力；滚轮、拖拽、点击和方向键只改变选择，Enter、空格、再次点击中心项或右侧主按钮才确认，避免滑动时产生有成本的创建动作；
