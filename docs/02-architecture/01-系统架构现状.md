...
- 关键决策：[ADR-0001](../09-decisions/0001-以教育能力为核心的个人智能体平台.md)、[ADR-0002](../09-decisions/0002-网关客户端渠道与能力节点.md)、[ADR-0003](../09-decisions/0003-统一运行时与笔记本上下文.md)、[ADR-0005](../09-decisions/0005-模块化单体产物与持久任务.md)、[ADR-0020](../09-decisions/0020-Personal与Notebook长期记忆边界.md)、[ADR-0021](../09-decisions/0021-模型能力独立Provider与继承规则.md)
...
Canvas 是跨 Source/Artifact 的统一工作面，不是 Notebook 的事实源。Source、Artifact 和运行记录仍由各自仓储持有；稳定边界见[统一 Canvas 工作面](04-统一画布工作面.md)。独立 Web Runtime、Experiment Runtime 及 TUI/Telegram 安全降级已实现；生产 Experiment Artifact 数据源和 UV 真人语音验收仍未完成。
...
flowchart TB
    ...
    Web --> Voice["Voice ticket + WebSocket\nshort utterance / classroom captions"]
    WebGeneral --> TurnApp
    WebTeaching --> TurnApp
