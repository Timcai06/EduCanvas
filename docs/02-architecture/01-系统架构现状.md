...
尚未完成的是 U13 Experiment Runtime 契约修订及其后续 CPU Adapter、实验 Renderer、跨入口交接和实时语音链路。统一 Canvas 的稳定边界见 [ADR-0009](../09-decisions/0009-统一画布工作面与运行时分层.md)，当前任务状态以 [UV 计划](../plan/active/UV-画布语音.md)为准。
