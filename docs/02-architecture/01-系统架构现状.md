...
Canvas 是跨 Source/Artifact 的统一工作面，不是 Notebook 的事实源。Source、Artifact 和运行记录仍由各自仓储持有；稳定边界见[统一 Canvas 工作面](04-统一画布工作面.md)。独立 Web Runtime、Experiment Runtime 及 TUI/Telegram 安全降级已实现；生产 Experiment Artifact 数据源仍未完成。Web Live Voice 的 Chrome/Safari 真麦克风、真实 Provider 连续轮次、工具、插话和失败恢复已由项目负责人在 2026-08-12 验收。
